@php
use App\Support\SispaqLocale;
use App\Support\SispaqMenu;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Route;

$profileUrl = Auth::check() ? SispaqMenu::profileUrlFor(Auth::user()) : null;
$paymentsUrl = Auth::check() ? SispaqMenu::paymentsUrlFor(Auth::user()) : null;
@endphp
...
<div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4 ms-0">
  <a href="{{ url('/') }}" class="app-brand-link">
    <span class="app-brand-logo demo">@include('_partials.um-logo', ['height' => 28])</span>
  ...
  <ul class="navbar-nav flex-row align-items-center ms-md-auto">
    ...
    <li class="nav-item dropdown-language dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end">
        <li>
          <a class="dropdown-item {{ app()->getLocale() === 'ms' ? 'active' : '' }}" href="{{ route('locale.switch', 'ms') }}"
            data-language="ms" data-text-direction="ltr">
            <span>{{ SispaqLocale::name('ms') }}</span>
          </a>
        </li>
        <li>
          <a class="dropdown-item {{ app()->getLocale() === 'en' ? 'active' : '' }}" href="{{ route('locale.switch', 'en') }}"
            data-language="en" data-text-direction="ltr">
            <span>{{ SispaqLocale::name('en') }}</span>
          </a>
        </li>
      </ul>
    </li>
      ...
      <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
        <div class="avatar avatar-online">
          <span class="avatar-initial rounded-circle bg-label-primary">
            {{ Auth::check() ? strtoupper(substr(Auth::user()->name, 0, 2)) : 'G' }}
          </span>
        </div>
      </a>
      <ul class="dropdown-menu dropdown-menu-end">
        <li>
          <a class="dropdown-item mt-0" href="{{ $profileUrl ?? 'javascript:void(0);' }}">
        ...
        <li>
          <a class="dropdown-item" href="{{ $profileUrl }}">
            ...
            <span class="align-middle">{{ __('sispaq.nav.profile') }}</span>
          </a>
        </li>
        @endif
        @if ($paymentsUrl)
        <li>
          <a class="dropdown-item" href="{{ $paymentsUrl }}">
            <i class="icon-base ti tabler-credit-card me-3 icon-md"></i>
            <span class="align-middle">{{ __('sispaq.nav.payments') }}</span>
          </a>
        </li>
        @endif
        @if ($profileUrl || $paymentsUrl)
        <li>
          <div class="dropdown-divider my-1 mx-n2"></div>
        </li>
        @endif
        <li>
          <a class="dropdown-item" href="{{ route('logout') }}"
            ...
            <i class="icon-base ti tabler-logout me-3 icon-md"></i><span class="align-middle">{{ __('sispaq.nav.logout') }}</span>
          </a>
        </li>
        ...
        <li>
          <div class="d-grid px-2 pt-2 pb-1">
            <a class="btn btn-sm btn-danger d-flex"
              ...
              <small class="align-middle">{{ __('sispaq.nav.login') }}</small>
